...
from biolearn.losses import slack_relu_ic_loss
...
def train_model(
    ...
    *,
    ...
    # Wrap model with slack variables; the loss reads system.slack
    wrapped = SlackModel(biosyst)
    ...
    try:
        trained_wrapped, training_info = train(
            wrapped,
            optimizer=optimizer,
            loss_fn=loss_fn,
            epochs=epochs,
        ...
        trained_syst = trained_wrapped.model
